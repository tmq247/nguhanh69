...
SUDO_USERS_ID = list(map(int, os.environ.get('6145782184', '5838967403').split()))
LOG_GROUP_ID = int(os.environ.get('LOG_GROUP_ID'))
GBAN_LOG_GROUP_ID = int(os.environ.get('GBAN_LOG_GROUP_ID', '-1002131020405'))
FMUTE_LOG_GROUP_ID = int(os.environ.get('FMUTE_LOG_GROUP_ID', '-1002131020405'))
